...
class ArithmeticListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ArithmeticParser#ifstmt.
    def enterIfstmt(self, ctx:ArithmeticParser.IfstmtContext):
        pass

    # Exit a parse tree produced by ArithmeticParser#ifstmt.
    def exitIfstmt(self, ctx:ArithmeticParser.IfstmtContext):
        pass
